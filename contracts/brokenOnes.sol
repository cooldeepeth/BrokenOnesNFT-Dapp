    ...
    PaymentSplitter 
{
    ...
    address[] private _team = [
        0x96aD5E680b51e59E8928beBed10ce0E6703C69f1, // Admin Account gets 25% of the total revenue
        0x84Ec00a9fBe47D5f6386f5477AB44d1EFd55D6CC
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("BrokenOnes", "BO")
